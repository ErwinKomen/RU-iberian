...
var ru = (function ($, ru) {
  ...
  ru.mapview = (function ($, config) {
    ...
    const tileUrl_1 = 'https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png',
        ...
        iberian_tiles = L.tileLayer(tileUrl, { attribution }),
      ...
      make_icon: function(name) {
        ...
        try {
          oBack = {
            ...
            // html: '<i class="fa fa-map-marker fa-alt" style="font-size: 24px; color: black;"></i>',
            ...
            // Laatst gebruikt: html: '<i class="fas fa-map-marker-alt" ></i>',
            // Hier moeten nu markers worden gemaakt die in kleur van elkaar verschillen, dezelfde kleuren als de "trefwoorden"
            // hebben
    ...
    return {
      ...
      iberian_map(el) {
        var frm = "#basiclist_filter",       // On basic_list.html
          map_id = "iberian_map",            // Part of map_view_full.html
          data = null,
          entries = null,
          lemma = "",
          label = "",
        ...
        try {
                ...
                if ('entries' in response) {
                  ...
                  if (main_map_object == null) {
                    ...
                    if (points.length > 0) {
                      ...
                      main_map_object = L.map(map_id).setView([point[0], point[1]], 12);
                      // Add it to my tiles
                      iberian_tiles.addTo(main_map_object);
                      // https://github.com/jawj/OverlappingMarkerSpiderfier-Leaflet to handle overlapping markers
                      loc_oms = new OverlappingMarkerSpiderfier(main_map_object, { keepSpiderfied: true });
          ...
          private_methods.errMsg("iberian_map", ex);
        }
      }
