...
from iberian.basic.models import UserSearch
...
class BasicDetails(DetailView):
    """Extension of the normal DetailView class for iberian"""
            ...
            if self.action == "":
                ...
                if self.dtype != "":
                    ...
                    if self.dtype == "excel":
                        ...
                        extension = "xml"
                    sDbName = "lila_{}_{}.{}".format(modelname, obj_id, extension)
                    sContentType = ""
                    if self.dtype == "csv":
                        ...
                        sDbName = "lila_{}_{}.svg".format(modelname, obj_id)
                        ...
                        if len(arPart) > 1:
                            ...
                            # Set the filename correctly
                            sDbName = "lila_{}_{}.png".format(modelname, obj_id)
